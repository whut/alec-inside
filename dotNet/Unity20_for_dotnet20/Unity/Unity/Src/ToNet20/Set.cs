...
namespace Wintellect.PowerCollections
{
    ...
    /// <p>OrderedSet is similar, but uses comparison instead of hashing, and does maintains
    /// the items in sorted order.</p>
    ///</remarks>    
    [Serializable]
    public class HashSet<T> : CollectionBase<T>, ICollection<T>, ICloneable
    {
        ...
        private HashSet(IEqualityComparer<T> equalityComparer, Hash<T> hash)
        {
            this.equalityComparer = equalityComparer;
            this.hash = hash;
        }
        ...
        {
            HashSet<T> newSet = new HashSet<T>(equalityComparer, hash.Clone(null));
            return newSet; 
        }
        ...
        public HashSet<T> CloneContents()
        {
            ...
            HashSet<T> clone = new HashSet<T>(equalityComparer);
        ...
        private void CheckConsistentComparison(HashSet<T> otherSet)
        {
            if (otherSet == null)
        ...
        public bool IsSupersetOf(HashSet<T> otherSet)
        {
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public bool IsProperSupersetOf(HashSet<T> otherSet)
        {
            CheckConsistentComparison(otherSet);
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public bool IsSubsetOf(HashSet<T> otherSet)
        {
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public bool IsProperSubsetOf(HashSet<T> otherSet)
        {
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public bool IsEqualTo(HashSet<T> otherSet)
        {
            CheckConsistentComparison(otherSet);
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public bool IsDisjointFrom(HashSet<T> otherSet)
        {
            CheckConsistentComparison(otherSet);
            HashSet<T> smaller, larger;
            if (otherSet.Count > this.Count) {
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public void UnionWith(HashSet<T> otherSet)
        {
            CheckConsistentComparison(otherSet);
        ...
        {
            CheckConsistentComparison(otherSet);
            HashSet<T> smaller, larger, result;
            if (otherSet.Count > this.Count) {
                smaller = this; larger = otherSet;
            }
            else {
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public void IntersectionWith(HashSet<T> otherSet)
        {
            CheckConsistentComparison(otherSet);
        ...
        public HashSet<T> Intersection(HashSet<T> otherSet)
        {
            ...
            result = new HashSet<T>(equalityComparer);
            foreach (T item in smaller) {
                if (larger.Contains(item))
                    result.Add(item);
            }
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public void DifferenceWith(HashSet<T> otherSet)
        {
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public void SymmetricDifferenceWith(HashSet<T> otherSet)
        {
            // main algorithm doesn't work correctly otherwise.
            if (this == otherSet)
                Clear();
        ...
        /// <exception cref="InvalidOperationException">This set and <paramref name="otherSet"/> don't use the same method for comparing items.</exception>
        public HashSet<T> SymmetricDifference(HashSet<T> otherSet)
        {
            CheckConsistentComparison(otherSet);
            HashSet<T> smaller, larger, result;
            if (otherSet.Count > this.Count) {
